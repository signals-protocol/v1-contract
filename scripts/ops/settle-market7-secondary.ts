...
async function main() {
  ...
  await core.finalizeSecondarySettlement.staticCall(MARKET_ID, SETTLEMENT_VALUE);
  const tx = await core.finalizeSecondarySettlement(MARKET_ID, SETTLEMENT_VALUE);
